...
Spectro::Spectro(vector<complex<float> > iq_samples, double carrier_freq,
...
in_ = (fftwf_complex*) fftwf_malloc(sizeof(fftwf_complex)*fft_size_);

out_ = (fftwf_complex*) fftwf_malloc(sizeof(fftwf_complex)*fft_size_);

plan_ = fftwf_plan_dft_1d(fft_size_, in_, out_, FFTW_FORWARD, FFTW_ESTIMATE);
